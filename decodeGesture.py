...
def match_pattern(dictionary="", sha1hash=""):
    ...
    print(f"Found hash: {sha1hash}\nIn Upper case: {str.upper(sha1hash)}")
...
def parse_opt():
    ...
    parser.add_option("-g", "--gesture", type="string", dest="gesture_file",
                      help="Path to your gesture.key file in your local system")
    parser.add_option("-d", "--dictionary", type="string", dest="dictionary_file",
                      help="Path to your dictionary file in your local system")
    # Parse options
